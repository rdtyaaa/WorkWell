<div class="w-full max-w-64 rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
    <a href="#">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <a href="{{ route('application.apply', $jobId) }}"
                class="rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800">
                Apply Now
            </a>
        </div>
    </div>
